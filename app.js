...
game.party.forEach(element => console.log(element.name));
...
pokemon.forEach(element => element.starter? console.log(element.name): false);
...
game.gymStatus = () => {
    game.gyms.forEach(element => element.completed? gymTally.completed++ : gymTally.incomplete++);
};
...
game.partyCount = () => {
    let count = 0;
    game.party.forEach(element => count++);
